...
//     const dataObj = await axios.get(`http://192.168.17.220:8097/api/v1/faculties/${facultyIdInput.value}`)
...
//     }else{
//     // Make put request
//     axios.put('http://192.168.17.220:8097/api/v1/faculties', submitForm).then((result) => {
//         console.log(result);
//         window.location.href = 'http://localhost:5500/XPUniversity/other/html/faculty/faculty.html'
//       }).catch((err) => {
//         console.log(err);
//       });
//     }
